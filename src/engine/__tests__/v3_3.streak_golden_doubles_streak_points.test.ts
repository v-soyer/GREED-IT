...
describe("GREED IT V3.3 - GOLD_STREAK_GOLDEN", () => {
  it("double les points du bonus streak", () => {
    const state = {
      bestScore: 0,
    ...
    expect(armed.streakMultiplier).toBe(2);

    const scored = applyAction(
      {
        ...armed,
        deck: { 1: 0, 2: 0, 3: 0, 4: 1, 5: 0, 6: 0, 7: 0, 8: 0, 9: 0, 10: 0, 11: 0, 12: 0, 13: 0 },
        goldDeck: {},
      } as any,
      { type: "FLIP" },
      () => 0.1,
